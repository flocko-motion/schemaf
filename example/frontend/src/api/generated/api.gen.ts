...
export type ListTodosReq = object;

export interface ListTodosResp {
  todos: Todo[];
}
...
> extends HttpClient<SecurityDataType> {
  api = {
     ...
     *
     * @name GetApiTodos
     * @summary Returns all todo items ordered by creation date.
     * @request GET:/api/todos
     */
    getApiTodos: (params: RequestParams = {}) =>
      this.request<ListTodosResp, void>({
        path: `/api/todos`,
        method: "GET",
        format: "json",
        ...params,
     ...
     */
    postApiTodos: (data: CreateTodoReq, params: RequestParams = {}) =>
     ...
     */
    deleteApiTodosId: (id: string, params: RequestParams = {}) =>
      this.request<void, void>({
        path: `/api/todos/${id}`,
        method: "DELETE",
        ...params,
     ...
     *
     * @name GetApiTodosId
     * @summary Retrieves a single todo item by ID.
     * @request GET:/api/todos/{id}
     */
    getApiTodosId: (id: string, params: RequestParams = {}) =>
      this.request<GetTodoResp, void>({
        path: `/api/todos/${id}`,
        method: "GET",
        format: "json",
        ...params,
     ...
     *
     * @name PutApiTodosId
     * @summary Updates the text and done status of a todo item.
